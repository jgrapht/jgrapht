...
public class GomoryHuCutTreeTest extends TestCase {
    ...
    public void testWikipediaGraph(){
        ...
        SimpleWeightedGraph<String, DefaultWeightedEdge> cutTree = 
            gomoryHuCutTree.getGomoryHuCutTreeGraph();
        ...
        Iterator<DefaultWeightedEdge> it = cutTree.edgeSet().iterator();
        while(it.hasNext()){
            assertTrue(cutTree.containsEdge(it.next()));
        }
    }
}
