...
/**
 * A graph implementation using fastutil's map implementations for storage specialized for integer
 * vertices. Edges can be of any object type.
 *
 * <p>
 * The following example creates a simple undirected weighted graph: <blockquote>
 *
 * <pre>
 * Graph&lt;Integer, DefaultWeightedEdge&gt; g = new FastutilMapIntVertexGraph&lt;&gt;(
...
public class FastutilMapIntVertexGraph<E> extends AbstractBaseGraph<Integer, E>
{
    ...
    public FastutilMapIntVertexGraph(
        Supplier<Integer> vertexSupplier, Supplier<E> edgeSupplier, GraphType type,
        boolean fastLookups)
    {
        super(
            vertexSupplier, edgeSupplier, type,
            fastLookups ? new FastutilFastLookupIntVertexGSS<>() : new FastutilIntVertexGSS<>());
    }
