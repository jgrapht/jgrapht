 ...
 * vertical or horizontal lines, trying to minimize crossings. In this particular problem one of the
 * two layers is considered fixed and the algorithm is allowed to adjust the positions of vertices
 * in the other layer.
 * 
 ...
 * 
 * The problem is NP-complete and the median heuristic is a 3-approximation algorithm.
 * 
