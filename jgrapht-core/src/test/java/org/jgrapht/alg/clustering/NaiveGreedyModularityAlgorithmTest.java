 ...
 * @author Tonia
 */
public class NaiveGreedyAlgorithmTest {
    @Test
    public void test1(){
        ...
        ClusteringAlgorithm<Integer> alg = new NaiveGreedyAlgorithm<>(g);
    ...
    public void testZacharyKarateClub(){
        ...
        assertEquals(Set.of(32, 33, 34, 9, 15, 16, 19, 21, 23, 24, 25, 26, 27, 28, 29, 30, 31), clustering.getClusters().get(1));
