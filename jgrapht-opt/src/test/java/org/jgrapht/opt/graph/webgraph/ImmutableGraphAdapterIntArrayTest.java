...
public class ImmutableGraphAdapterIntArrayTest
{
    ...
    private static ObjectOpenCustomHashSet<int[]> unorderedSingleton(final int x, final int y)
    {
        return new ObjectOpenCustomHashSet<>(
            new int[][] { new int[] { x, y } }, UNORDERED_HASH_STRATEGY);
    }

    private static ObjectOpenCustomHashSet<int[]> orderedSingleton(final int x, final int y)
    {
        return new ObjectOpenCustomHashSet<>(
            new int[][] { new int[] { x, y } }, IntArrays.HASH_STRATEGY);
    }
    ...
    public void testSmallRandom()
    {
        for (final int size : new int[] { 10, 100, 500 }) {
            ...
            final ImmutableGraphAdapterIntArray a =
                ImmutableGraphAdapterIntArray.directed(g, Transform.transpose(g));
        ...
        SecurityException
    {
        final File basename = File
            .createTempFile(ImmutableGraphAdapterEndpointPairTest.class.getSimpleName(), "test");
        ...
        IOException
    {
        ...
        final ImmutableGraphAdapterIntArray b =
            ImmutableGraphAdapterIntArray.directed(ef, Transform.transpose(ef));
        ...
        assertEquals(
            ordered(new int[] { 0, 1 }, new int[] { 0, 2 }, new int[] { 1, 2 }, new int[] { 2, 2 }),
            a.edgeSet());
        assertEquals(
            ordered(new int[] { 0, 1 }, new int[] { 0, 2 }, new int[] { 1, 2 }, new int[] { 2, 2 }),
            ordered(a.iterables().edges()));

        assertEquals(ordered(new int[] { 0, 1 }, new int[] { 1, 2 }), a.edgesOf(1));
        assertEquals(
            ordered(new int[] { 0, 1 }, new int[] { 1, 2 }), ordered(a.iterables().edgesOf(1)));
         ...
         *
         * Assertions.assertThrows(UnsupportedOperationException.class, () -> { a.addEdge(0, 1, new
         * int[] { 0, 1 }); });
         *
         * Assertions.assertThrows(UnsupportedOperationException.class, () -> { a.removeEdge(0, 1);
         * });
         *
         * Assertions.assertThrows(UnsupportedOperationException.class, () -> { a.removeEdge(new
         * int[] { 0, 1 }); });
         *
         * Assertions.assertThrows(UnsupportedOperationException.class, () -> { a.setEdgeWeight(new
         * int[] { 0, 1 }, 0); });
         *
        ...
        IOException
    {
        ...
        assertEquals(
            unordered(new int[] { 0, 2 }, new int[] { 2, 3 }), unordered(a.incomingEdgesOf(2)));
        assertEquals(
            unordered(new int[] { 0, 2 }, new int[] { 2, 3 }), unordered(a.outgoingEdgesOf(2)));
        assertEquals(
            unordered(new int[] { 0, 2 }, new int[] { 2, 3 }), unordered(a.iterables().edgesOf(2)));
        assertEquals(
            unordered(new int[] { 0, 2 }, new int[] { 2, 3 }),
            unordered(a.iterables().incomingEdgesOf(2)));
        assertEquals(
            unordered(new int[] { 0, 2 }, new int[] { 2, 3 }),
            unordered(a.iterables().outgoingEdgesOf(2)));
        ...
        IOException
    {
        ...
        ImmutableGraphAdapterIntArray a =
            ImmutableGraphAdapterIntArray.directed(v, Transform.transpose(v));
        ...
        IOException
    {
        ...
        assertEquals(
            ordered(new int[] { 0, 2 }, new int[] { 0, 1 }, new int[] { 1, 3 }, new int[] { 2, 3 }),
            a.edgeSet());
        ...
        assertEquals(
            unordered(
                new int[] { 0, 2 }, new int[] { 0, 1 }, new int[] { 1, 3 }, new int[] { 2, 3 }),
            unordered(a.edgeSet()));
        assertEquals(
            unordered(
                new int[] { 0, 2 }, new int[] { 0, 1 }, new int[] { 1, 3 }, new int[] { 2, 3 }),
            unordered(a.iterables().edges()));
    }
