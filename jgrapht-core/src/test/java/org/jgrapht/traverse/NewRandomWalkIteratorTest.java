 ...
 *
 */
public class NewRandomWalkIteratorTest
{
    ...
    public void testEmptyGraph()
    {
        ...
        new NewRandomWalkIterator<>(graph, "unknown", 100);
    }
    ...
    public void testSingleNode()
    {
        Graph<String, DefaultEdge> graph = new DefaultDirectedGraph<>(DefaultEdge.class);
        graph.addVertex("123");
        Iterator<String> iter = new NewRandomWalkIterator<>(graph, "123");
    ...
    public void testSink()
    {
        ...
        Iterator<String> iter =
            new NewRandomWalkIterator<>(graph, graph.vertexSet().iterator().next());
    ...
    public void testExhausted()
    {
        ...
        graphGenerator.generateGraph(graph);
        long maxSteps = 4;
        Iterator<String> iter = new NewRandomWalkIterator<>(graph, "1", maxSteps);
    ...
    public void testDeterministic()
    {
        ...
        graphGenerator.generateGraph(graph);
        Iterator<String> iter = new NewRandomWalkIterator<>(graph, "0", 20);
        int step = 0;
        while (iter.hasNext()) {
    ...
    public void testLongTime()
    {
        ...
        Iterator<String> iter = new NewRandomWalkIterator<>(graph, "0");
        int count = 0;
        List<String> walk = new ArrayList<>();
        while (iter.hasNext()) {
            if (count >= 10000) { 
