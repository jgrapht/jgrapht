 ...
 */
public interface WeightedVertexCoverTest extends VertexCoverTestBase {

     <V, E> MinimumWeightedVertexCoverAlgorithm<V, E> createWeightedSolver();

    // ------- Helper methods ------

    default Map<Integer, Double> getRandomVertexWeights(Graph<Integer, DefaultEdge> graph)
    {
