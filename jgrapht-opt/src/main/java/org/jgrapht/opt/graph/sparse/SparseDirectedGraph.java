...
/**
 * A sparse unmodifiable directed graph.
 * 
    ...
    AbstractGraph<Integer, Integer>
{
    ...
    private CSRBooleanMatrix outIncidenceMatrixT;
    private CSRBooleanMatrix inIncidenceMatrix;
    private CSRBooleanMatrix inIncidenceMatrixT;
    ...
    {
        assertEdgeExist(e);
        return outIncidenceMatrixT.nonZerosIterator(e).next();
    }
    ...
    {
        assertEdgeExist(e);
        return inIncidenceMatrixT.nonZerosIterator(e).next();
    }
