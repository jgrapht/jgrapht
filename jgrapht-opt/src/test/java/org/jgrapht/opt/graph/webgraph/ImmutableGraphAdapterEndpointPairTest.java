...
public class ImmutableGraphAdapterEndpointPairTest
{
    ...
    public void testSmallRandom()
    {
        for (final int size : new int[] { 10, 100, 500 }) {
            ...
            final ImmutableGraphAdapterEndpointPair a =
                ImmutableGraphAdapterEndpointPair.directed(g, Transform.transpose(g));
        ...
        IOException
    {
         ...
         * ImmutableGraphAdapterEndpointPair.directed(g, new
         * ArrayListMutableGraph().immutableView()); });
         */

        final ImmutableGraphAdapterEndpointPair a =
            ImmutableGraphAdapterEndpointPair.directed(g, t);
        final ImmutableGraphAdapterEndpointPair b =
            ImmutableGraphAdapterEndpointPair.directed(ef, Transform.transpose(ef));
        ...
        assertEquals(
            Collections.singleton(EndpointPair.ordered(0, 1)),
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0, 1), EndpointPair.ordered(0, 2),
                    EndpointPair.ordered(1, 2), EndpointPair.ordered(2, 2) }),
            a.edgeSet());
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0, 1), EndpointPair.ordered(0, 2),
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0, 1), EndpointPair.ordered(1, 2) }),
            a.edgesOf(1));
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0, 1), EndpointPair.ordered(1, 2) }),
        ...
        assertEquals(
            new ObjectOpenHashSet(new EndpointPair[] { EndpointPair.ordered(0, 1) }),
            a.incomingEdgesOf(1));
        assertEquals(
            new ObjectOpenHashSet(new EndpointPair[] { EndpointPair.ordered(0, 1) }),
        ...
        assertEquals(
            new ObjectOpenHashSet(new EndpointPair[] { EndpointPair.ordered(1, 2) }),
            a.outgoingEdgesOf(1));
        assertEquals(
            new ObjectOpenHashSet(new EndpointPair[] { EndpointPair.ordered(1, 2) }),
        ...
        IOException
    {
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.unordered(0, 2), EndpointPair.unordered(2, 3) }),
            a.edgesOf(2));
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.unordered(0, 2), EndpointPair.unordered(2, 3) }),
        ...
        IOException
    {
        ...
        ImmutableGraphAdapterEndpointPair a =
            ImmutableGraphAdapterEndpointPair.directed(v, Transform.transpose(v));
        ...
        IOException
    {
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0, 2), EndpointPair.ordered(0, 1),
                    EndpointPair.ordered(1, 3), EndpointPair.ordered(2, 3) }),
            a.edgeSet());
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0, 2), EndpointPair.ordered(0, 1),
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.unordered(0, 2), EndpointPair.unordered(0, 1),
                    EndpointPair.unordered(1, 3), EndpointPair.unordered(2, 3) }),
            a.edgeSet());
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.unordered(0, 2), EndpointPair.unordered(0, 1),
