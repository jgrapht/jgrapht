...
public class ImmutableBigGraphAdapterEndpointPairTest
{
    ...
    public void testSmallRandom()
    {
        for (final int size : new int[] { 10, 100, 500 }) {
            ...
            final ImmutableBigGraphAdapterEndpointPair a = new ImmutableBigGraphAdapterEndpointPair(
        ...
        SecurityException
    {
        final File basename = File
            .createTempFile(ImmutableBigGraphAdapterEndpointPairTest.class.getSimpleName(), "test");
        ...
        IOException
    {
        ...
        final ImmutableBigGraphAdapterEndpointPair a =
            new ImmutableBigGraphAdapterEndpointPair(g, t);
        final ImmutableBigGraphAdapterEndpointPair b = new ImmutableBigGraphAdapterEndpointPair(
        ...
        assertEquals(
            Collections.singleton(EndpointPair.ordered(0L, 1L)),
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Long>>(
                new EndpointPair[] { EndpointPair.ordered(0L, 1L), EndpointPair.ordered(0L, 2L),
                    EndpointPair.ordered(1L, 2L), EndpointPair.ordered(2L, 2L) }),
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Long>>(
                new EndpointPair[] { EndpointPair.ordered(0L, 1L), EndpointPair.ordered(1L, 2L) }),
            a.edgesOf(1L));
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Long>>(
                new EndpointPair[] { EndpointPair.ordered(0L, 1L), EndpointPair.ordered(1L, 2L) }),
        ...
        assertEquals(
            new ObjectOpenHashSet(new EndpointPair[] { EndpointPair.ordered(0L, 1L) }),
        ...
        assertEquals(
            new ObjectOpenHashSet(new EndpointPair[] { EndpointPair.ordered(1L, 2L) }),
        ...
        IOException
    {
        ...
        final ImmutableBigGraphAdapterEndpointPair a =
            ImmutableBigGraphAdapterEndpointPair.undirected(g);
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Long>>(
                new EndpointPair[] { EndpointPair.unordered(0L, 2L),
                    EndpointPair.unordered(2L, 3L) }),
            a.edgesOf(2L));
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Long>>(
                new EndpointPair[] { EndpointPair.unordered(0L, 2L),
        ...
        assertEquals(
            Collections.singleton(EndpointPair.unordered(0L, 1L)),
            new ObjectOpenHashSet<>(a.iterables().allEdges(0L, 1L).iterator()));
        ...
        IOException
    {
        ...
        ImmutableBigGraphAdapterEndpointPair a = ImmutableBigGraphAdapterEndpointPair
        ...
        IOException
    {
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0L, 2L), EndpointPair.ordered(0L, 1L),
                    EndpointPair.ordered(1L, 3L), EndpointPair.ordered(2L, 3L) }),
            a.edgeSet());
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.ordered(0L, 2L), EndpointPair.ordered(0L, 1L),
        ...
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.unordered(0L, 2L), EndpointPair.unordered(0L, 1L),
                    EndpointPair.unordered(1L, 3L), EndpointPair.unordered(2L, 3L) }),
            a.edgeSet());
        assertEquals(
            new ObjectOpenHashSet<EndpointPair<Integer>>(
                new EndpointPair[] { EndpointPair.unordered(0L, 2L), EndpointPair.unordered(0L, 1L),
        ...
        final ImmutableGraph m = ImmutableGraph
            .wrap(
                new ArrayListMutableGraph(2, new int[][] { new int[] { 0, 1 }, new int[] { 1, 0 } })
                    .immutableView());
        final ImmutableBigGraphAdapterEndpointPair a =
            ImmutableBigGraphAdapterEndpointPair.undirected(m);
