...
public class BetweennessCentralityTest
{
    ...
    {
        Graph<String, DefaultWeightedEdge> g = createWeighted6();
        VertexScoringAlgorithm<String, Double> bc = new BetweennessCentrality<>(g);
        Map<String, Double> scores = bc.getScores();
        assertGraph6(scores);
    ...
    private Graph<Integer, DefaultEdge> createWeighted6()
    {
        Graph<Integer, DefaultEdge> g = new SimpleDirectedWeightedGraph<>(DefaultEdge.class);
        g.addVertex(0);
        g.addVertex(1);
        g.addVertex(2);
