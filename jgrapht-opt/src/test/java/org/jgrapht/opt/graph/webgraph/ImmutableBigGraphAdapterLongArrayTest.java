...
public class ImmutableBigGraphAdapterLongArrayTest
{
    ...
    private static ObjectOpenCustomHashSet<long[]> unorderedSingleton(final long x, final long y)
    {
        return new ObjectOpenCustomHashSet<>(
            new long[][] { new long[] { x, y } }, UNORDERED_HASH_STRATEGY);
    }

    private static ObjectOpenCustomHashSet<long[]> orderedSingleton(final long x, final long y)
    {
        return new ObjectOpenCustomHashSet<>(
            new long[][] { new long[] { x, y } }, LongArrays.HASH_STRATEGY);
    }
    ...
    public void testSmallRandom()
    {
        for (final int size : new int[] { 10, 100, 500 }) {
            ...
            final ImmutableBigGraphAdapterLongArray a = new ImmutableBigGraphAdapterLongArray(
        ...
        SecurityException
    {
        final File basename = File
            .createTempFile(ImmutableBigGraphAdapterLongArrayTest.class.getSimpleName(), "test");
        ...
        IOException
    {
        ...
        final ImmutableBigGraphAdapterLongArray b =
            new ImmutableBigGraphAdapterLongArray(ef, ImmutableGraph.wrap(Transform.transpose(mg)));
        ...
        assertEquals(
            ordered(
                new long[] { 0L, 1L }, new long[] { 0L, 2L }, new long[] { 1L, 2L },
                new long[] { 2L, 2L }),
            a.edgeSet());
        assertEquals(
            ordered(
        ...
        assertEquals(
            ordered(new long[] { 0L, 1L }, new long[] { 1L, 2L }),
            ordered(a.iterables().edgesOf(1L)));
        ...
        IOException
    {
        ...
        assertEquals(
            unordered(new long[] { 0L, 2L }, new long[] { 2L, 3L }), unordered(a.edgesOf(2L)));
        assertEquals(
            unordered(new long[] { 0L, 2L }, new long[] { 2L, 3L }),
            unordered(a.incomingEdgesOf(2L)));
        assertEquals(
            unordered(new long[] { 0L, 2L }, new long[] { 2L, 3L }),
            unordered(a.outgoingEdgesOf(2L)));
        assertEquals(
            unordered(new long[] { 0L, 2L }, new long[] { 2L, 3L }),
            unordered(a.iterables().edgesOf(2L)));
        assertEquals(
            unordered(new long[] { 0L, 2L }, new long[] { 2L, 3L }),
            unordered(a.iterables().incomingEdgesOf(2L)));
        assertEquals(
            unordered(new long[] { 0L, 2L }, new long[] { 2L, 3L }),
            unordered(a.iterables().outgoingEdgesOf(2L)));
        ...
        IOException
    {
        ...
        ImmutableBigGraphAdapterLongArray a = ImmutableBigGraphAdapterLongArray
        ...
        IOException
    {
        ...
        assertEquals(
            ordered(
                new long[] { 0L, 2L }, new long[] { 0L, 1L }, new long[] { 1L, 3L },
                new long[] { 2L, 3L }),
            a.edgeSet());
